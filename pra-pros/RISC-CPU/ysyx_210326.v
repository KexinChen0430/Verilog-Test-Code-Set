...
/*------------------- 全局参数 -------------------*/
`define YSYX210326_RST_ENABLE      1'b1                // 复位信号有效  YSYX210326_RST_ENABLE
`define YSYX210326_RST_DISABLE     1'b0                // 复位信号无效
`define YSYX210326_ZERO_WORD       64'b0               // 64位的数值0
`define YSYX210326_ZERO_INST       32'b0               // 32位的数值0
`define YSYX210326_WRITE_ENABLE    1'b1                // 使能写
`define YSYX210326_WRITE_DISABLE   1'b0                // 禁止写
`define YSYX210326_READ_ENABLE     1'b1                // 使能读
`define YSYX210326_READ_DISABLE    1'b0                // 禁止读
`define YSYX210326_ALUOP_BUS       7 : 0               // 译码阶段的输出aluop_o的宽度
`define YSYX210326_YSYX210326_SHIFT_ENABLE    1'b1                // 移位指令使能 
`define YSYX210326_ALUTYPE_BUS     2 : 0               // 译码阶段的输出alutype_o的宽度  
`define YSYX210326_TRUE_V          1'b1                // 逻辑"真"  
`define YSYX210326_FALSE_V         1'b0                // 逻辑"假"  
`define YSYX210326_JUMP_ENABLE     1'b1                // 预测跳转
`define YSYX210326_JUMP_DISABLE    1'b0                // 预测不跳转
`define YSYX210326_CHIP_ENABLE     1'b1                // 芯片使能  
`define YSYX210326_CHIP_DISABLE    1'b0                // 芯片禁止  
`define YSYX210326_WORD_BUS        63: 0               // 64位宽
`define YSYX210326_DOUBLE_REG_BUS  127: 0              // 两倍的通用寄存器的数据线宽度
`define YSYX210326_RT_ENABLE       1'b1                // rt选择使能
`define YSYX210326_SIGNED_EXT      1'b1                // 符号扩展使能
`define YSYX210326_IMM_ENABLE      1'b1                // 立即数选择使能
`define YSYX210326_UPPER_ENABLE    1'b1                // 立即数移位使能
`define YSYX210326_MREG_ENABLE     1'b1                // 写回阶段存储器结果选择信号
`define YSYX210326_BSEL_BUS        3 : 0              // 数据存储器字节选择信号宽度
`define YSYX210326_DATA_ADDR_BUS   63 : 0              // 数据存储器的地址宽度
/************************转移指令添加 begin*******************************/
`define YSYX210326_JUMP_BUS        25: 0               // J型指令字中instr_index字段的宽度
//`define JTSEL_BUS       1 : 0               // 转移地址选择信号的宽度
/*********************** 转移指令添加 end*********************************/
`define YSYX210326_PC_INIT         64'h00000000_30000000               // PC初始值
`define YSYX210326_INST_INIT       32'b0               //指令初始值

/*------------------- 指令字参数 -------------------*/
`define YSYX210326_INST_ADDR_BUS   63: 0               // 指令的地址宽度
`define YSYX210326_INST_BUS        31: 0               // 指令的数据宽度

// 操作类型alutype
`define YSYX210326_NOP             3'b000
`define YSYX210326_ARITH           3'b001
`define YSYX210326_LOGIC           3'b010
`define YSYX210326_MOVE            3'B011
`define YSYX210326_SHIFT           3'b100
...
`define YSYX210326_RISCV64_ADDI        8'h11
`define YSYX210326_RISCV64_SLTI        8'h12
`define YSYX210326_RISCV64_SLTIU       8'h13
`define YSYX210326_RISCV64_ADD         8'h14
`define YSYX210326_RISCV64_SUB         8'h15
`define YSYX210326_RISCV64_SLT         8'h16
`define YSYX210326_RISCV64_SLTU        8'h17
`define YSYX210326_RISCV64_ADDIW		8'h18
`define YSYX210326_RISCV64_ADDW		8'h19
`define YSYX210326_RISCV64_SUBW		8'h1A

`define YSYX210326_RISCV64_ANDI        8'h21
`define YSYX210326_RISCV64_ORI         8'h22
`define YSYX210326_RISCV64_XORI        8'h23
`define YSYX210326_RISCV64_AND         8'h24
`define YSYX210326_RISCV64_OR          8'h25
`define YSYX210326_RISCV64_XOR         8'h26

`define YSYX210326_RISCV64_SLLI        8'h41
`define YSYX210326_RISCV64_SRLI        8'h42
`define YSYX210326_RISCV64_SRAI        8'h43
`define YSYX210326_RISCV64_SLL         8'h44
`define YSYX210326_RISCV64_SRL         8'h45
`define YSYX210326_RISCV64_SRA         8'h46
`define YSYX210326_RISCV64_SLLIW		8'h47
`define YSYX210326_RISCV64_SRLIW		8'h48
`define YSYX210326_RISCV64_SRAIW		8'h49
`define YSYX210326_RISCV64_SLLW		8'h4A
`define YSYX210326_RISCV64_SRLW		8'h4B
`define YSYX210326_RISCV64_SRAW		8'h4C

`define YSYX210326_RISCV64_LUI         8'h51
`define YSYX210326_RISCV64_AUIPC       8'h52
`define YSYX210326_RISCV64_JAL         8'h53
`define YSYX210326_RISCV64_JALR        8'h54

`define YSYX210326_RISCV64_MUL         8'h80
`define YSYX210326_RISCV64_MULH        8'h81
`define YSYX210326_RISCV64_MULHU       8'h82
`define YSYX210326_RISCV64_MULHSU      8'h83

`define YSYX210326_RISCV64_CSRRW       8'h01
`define YSYX210326_RISCV64_CSRRS       8'h02
`define YSYX210326_RISCV64_CSRRC       8'h03
`define YSYX210326_RISCV64_CSRRWI      8'h04
`define YSYX210326_RISCV64_CSRRSI      8'h05
`define YSYX210326_RISCV64_CSRRCI      8'h06

`define YSYX210326_RISCV64_ECALL       8'hf1
`define YSYX210326_RISCV64_MRET        8'hf2
...
`define REG_YSYX210326_NOP         5'b00000            // 零号寄存器
...
module ysyx_210326_axi_rw # (
    ...
    assign apb_addr_rena = ( r_addr_i[31:12] == `SPI_CTRL_ADDR || r_addr_i[31:28] == `FLASH_ADDR)   ?   `YSYX210326_TRUE_V :   `YSYX210326_FALSE_V;
    assign apb_addr_wena = ( w_addr_i[31:12] == `SPI_CTRL_ADDR || w_addr_i[31:28] == `FLASH_ADDR)   ?   `YSYX210326_TRUE_V :   `YSYX210326_FALSE_V;
    ...
    //  for reYSYX210326_MOVE warning sign
    
    assign test_warning = (w_addr_i == `YSYX210326_ZERO_WORD && axi_b_id_i == 4'b0 && axi_r_id_i == 4'b0 && addr_end == 4'b0)  ?   `YSYX210326_FALSE_V    :   `YSYX210326_FALSE_V;
    ...
    wire w_done     =(test_warning == `YSYX210326_FALSE_V) ? w_hs & axi_w_last_o   :  w_hs & axi_w_last_o;
    ...
    always @(posedge clock) begin
        if(reset) begin
            aw_valid <= `YSYX210326_FALSE_V;
        end
        else if(w_ena == `YSYX210326_TRUE_V && aw_hs == `YSYX210326_FALSE_V) begin
            aw_valid <= `YSYX210326_TRUE_V;
        end
        else if(aw_hs == `YSYX210326_TRUE_V) begin
            aw_valid <= `YSYX210326_FALSE_V;
        end
    end 


    assign axi_aw_valid_o   = (aw_valid == `YSYX210326_TRUE_V && w_ena) ? w_state_addr : `YSYX210326_FALSE_V;
    assign axi_aw_addr_o    =   (uart_addr_wena == `YSYX210326_TRUE_V) ?   w_addr_i[31: 0]    :   
                                (apb_addr_wena == `YSYX210326_TRUE_V)  ?   {w_addr_i[31: 2],2'b0}  :   {w_addr_i[AXI_ADDR_WIDTH-1:ALIGNED_WIDTH], {ALIGNED_WIDTH{1'b0}}};
    assign axi_aw_id_o      = axi_id;
    assign axi_aw_len_o     = axi_len;
    assign axi_aw_size_o    =   (uart_addr_wena == `YSYX210326_TRUE_V)   ?   3'b000    :  
                                (apb_addr_wena == `YSYX210326_TRUE_V)    ?   3'b010  :   axi_size;
    assign axi_aw_burst_o   = `AXI_BURST_TYPE_INCR;

    //  Write data channel signals
    assign axi_w_valid_o    = w_state_write;
    assign axi_w_data_o     =   (uart_addr_wena == `YSYX210326_TRUE_V || apb_addr_wena == `YSYX210326_TRUE_V && r_addr_i[2] == 1'b0) ?   {32'b0,data_write_i[31: 0]} :
                                (uart_addr_wena == `YSYX210326_TRUE_V || apb_addr_wena == `YSYX210326_TRUE_V && r_addr_i[2] == 1'b1) ?   {32'b0,data_write_i[63:32]} :  data_write_i;
    assign axi_w_strb_o     =   (uart_addr_wena == `YSYX210326_TRUE_V || apb_addr_wena == `YSYX210326_TRUE_V && r_addr_i[2] == 1'b0) ?   wmask    :
                                (uart_addr_wena == `YSYX210326_TRUE_V || apb_addr_wena == `YSYX210326_TRUE_V && r_addr_i[2] == 1'b1) ?   {4'b0,wmask[ 7: 4]}  :
                                wmask;
    ...
    assign axi_ar_valid_o   = (r_valid_i) ? r_state_addr : `YSYX210326_FALSE_V;
    assign axi_ar_addr_o    =   (uart_addr_rena == `YSYX210326_TRUE_V)   ?   r_addr_i    :
                                (apb_addr_rena == `YSYX210326_TRUE_V)    ?   {r_addr_i[31:2],2'b0}   :   axi_addr;
    assign axi_ar_id_o      = axi_id;
    assign axi_ar_len_o     = axi_len;
    assign axi_ar_size_o    =   (uart_addr_rena == `YSYX210326_TRUE_V)   ?   3'b000  :
                                (apb_addr_rena == `YSYX210326_TRUE_V)    ?   3'b010  :   axi_size;
    ...
    wire [63: 0] r_data_i_apb_select =  (size_w)    ?   {32'b0,axi_r_data_i[31: 0]} :
                                        (size_h == `YSYX210326_TRUE_V & r_addr_i[1] == 1'b0)   ?   {48'b0,axi_r_data_i[15: 0]} :
                                        (size_h == `YSYX210326_TRUE_V & r_addr_i[1] == 1'b1)   ?   {48'b0,axi_r_data_i[31:16]} :
                                        (size_b == `YSYX210326_TRUE_V & r_addr_i[1:0] == 2'b0)     ?   {56'b0,axi_r_data_i[ 7: 0]} :
                                        (size_b == `YSYX210326_TRUE_V & r_addr_i[1:0] == 2'b01)    ?   {56'b0,axi_r_data_i[15: 8]} :
                                        (size_b == `YSYX210326_TRUE_V & r_addr_i[1:0] == 2'b10)    ?   {56'b0,axi_r_data_i[23:16]} :
                                        (size_b == `YSYX210326_TRUE_V & r_addr_i[1:0] == 2'b11)    ?   {56'b0,axi_r_data_i[31:24]} :   `YSYX210326_ZERO_WORD;
    ...
    assign data_read_o = (apb_addr_rena == `YSYX210326_TRUE_V) ?   data_read_o_apb : data_read_o_ddr;

endmodule



module ysyx_210326_btb(
        input   wire        cpu_rst_n,
        input   wire        cpu_clk_50M,
        
        input   wire[`PC_ADDR_BTB  ]     pc_tag,    			//输入PC的【11：2】位作为检索地址
        output  reg                      btb_jump_ena,          //对外输出信号，预测下条指令是否跳转
        output  reg [`YSYX210326_INST_ADDR_BUS]     btb_prepc_o,	        //从btb 中得到的预测PC
        input   wire                     wr_req,                //写请求信号
        input   wire[`PC_ADDR_BTB  ]     wr_pc_tag,             //要写入的分支PC_tag
        input   wire[`YSYX210326_INST_ADDR_BUS]     wr_predicted_pc,       //要写入的预测PC
        ...
        wire [1:0]  update_jump_state   =   (valid[wr_pc_tag] 	  == `YSYX210326_FALSE_V 	  	&& wr_jump_state == `YSYX210326_FALSE_V)		?	`WEAK_NOTJUMP	        	:
											(valid[wr_pc_tag] 	  == `YSYX210326_FALSE_V     	&& wr_jump_state == `YSYX210326_TRUE_V )		?	`WEAK_JUMP		            :
											(pre_state[wr_pc_tag] == `STRONG_JUMP 	&& wr_jump_state == `YSYX210326_TRUE_V )		?	`STRONG_JUMP	            :
											(pre_state[wr_pc_tag] != `STRONG_JUMP 	&& wr_jump_state == `YSYX210326_TRUE_V )		?	(pre_state[wr_pc_tag] + 1)	:
											(pre_state[wr_pc_tag] == `STRONG_NOTJUMP&& wr_jump_state == `YSYX210326_FALSE_V)		?	`STRONG_NOTJUMP	:
											(pre_state[wr_pc_tag] != `STRONG_NOTJUMP&& wr_jump_state == `YSYX210326_FALSE_V)		?	(pre_state[wr_pc_tag] - 1)	:	`WEAK_JUMP;

        always @(posedge cpu_clk_50M)   begin
            if (cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            end
			else begin
				if (wr_req == `YSYX210326_WRITE_ENABLE) 
				    valid       [wr_pc_tag]    <=  `YSYX210326_TRUE_V; 
		...
		always @(*)   begin
            if (cpu_rst_n == `YSYX210326_RST_ENABLE)	begin
				btb_jump_ena		=	`YSYX210326_JUMP_DISABLE;
				btb_prepc_o			=	`YSYX210326_ZERO_WORD;
			end
			else if (valid[pc_tag] == `YSYX210326_FALSE_V) begin
                btb_jump_ena        =   `YSYX210326_JUMP_DISABLE;
				btb_prepc_o			=	`YSYX210326_ZERO_WORD;
			end
			else 	begin
...
module ysyx_210326_clint(
    input   wire                cpu_clk_50M,
    input   wire                cpu_rst_n,

    input   wire                read_en,
    input   wire[`YSYX210326_WORD_BUS]     read_addr,
    output  reg [`YSYX210326_WORD_BUS]     data_read,

    input   wire                write_en,
    input   wire[`YSYX210326_WORD_BUS]     write_addr,
    input   wire[`YSYX210326_WORD_BUS]     data_write,
    ...
    assign  interr = (interr_ena == `YSYX210326_TRUE_V && mtime >= mtimecmp)   ?    `INT_ON :  `INT_OFF;

    always @(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            interr_ena  <= `YSYX210326_TRUE_V;
        end
        else if(interr_isdone == `YSYX210326_TRUE_V) begin
            interr_ena  <= `YSYX210326_FALSE_V;
        end
        else if(mtime < mtimecmp /*&& interr_ena == `YSYX210326_FALSE_V*/) begin
            interr_ena  <= `YSYX210326_TRUE_V;
        end
    end
    ...
    always @(posedge cpu_clk_50M) begin
        ...
        else if(write_en == `YSYX210326_TRUE_V && write_addr == `MTIME_ADDR) begin
            mtime   <=  data_write;
        end
        else begin
            mtime   <=  mtime + 1;
    ...
    always @(posedge cpu_clk_50M) begin
        ...
        else if(write_en == `YSYX210326_TRUE_V && write_addr == `MTIMECMP_ADDR) begin
            mtimecmp    <=  data_write;
        end
    end
    ...
    always @(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            data_read   <=   `YSYX210326_ZERO_WORD;
        end
        else if(read_en == `YSYX210326_TRUE_V && read_addr == `MTIME_ADDR) begin
            data_read   <=   mtime;
        end
        else if(read_en == `YSYX210326_TRUE_V && read_addr == `MTIMECMP_ADDR) begin
            data_read   <=   mtimecmp;
        end
        else begin
            data_read   <=   `YSYX210326_ZERO_WORD;
...
module ysyx_210326_csrfile(
	...
	always @(posedge cpu_clk_50M) begin
		if (cpu_rst_n == `YSYX210326_RST_ENABLE) begin
			csrs[ 0] <= `YSYX210326_ZERO_WORD;
			csrs[ 1] <= `YSYX210326_ZERO_WORD;
			csrs[ 2] <= `YSYX210326_ZERO_WORD;
			csrs[ 3] <= `YSYX210326_ZERO_WORD;
			csrs[ 4] <= `YSYX210326_ZERO_WORD;
			csrs[ 5] <= `YSYX210326_ZERO_WORD;
			csrs[ 6] <= `YSYX210326_ZERO_WORD;
			csrs[ 7] <= `YSYX210326_ZERO_WORD;
			csrs[ 8] <= `YSYX210326_ZERO_WORD;
		end
		/*********************异常处理相关指令***************************/
		...
		/*********************异常处理相关指令***************************/
		else if((csr_we == `YSYX210326_WRITE_ENABLE) && (csr_waddr == `MSTATUS)) begin
			csrs[csr_waddr] <= csr_wdata;
			csrs[`SSTATUS][63]	 <= csr_wdata[63];
			csrs[`SSTATUS][16:13]<= csr_wdata[16:13];
			csrs[`MCYCLE]	<= csrs[`MCYCLE] + 1;
		end
		else if((csr_we == `YSYX210326_WRITE_ENABLE) && (csr_waddr != `MCYCLE))begin
			csrs[csr_waddr] <= csr_wdata;
			csrs[`MCYCLE]	<= csrs[`MCYCLE] + 1;
		end
		else if((csr_we == `YSYX210326_WRITE_ENABLE) && (csr_waddr == `MCYCLE))begin
	...
	always @(*) begin
		if (cpu_rst_n == `YSYX210326_RST_ENABLE) begin
			csr_rdata = `YSYX210326_ZERO_WORD;
		end
		else if ((csr_we == `YSYX210326_WRITE_ENABLE) && (csr_waddr == csr_raddr)) begin
			csr_rdata = csr_wdata;
		end
		else begin
...
module ysyx_210326_exemem_reg(
	input	wire					cpu_clk_50M,
	input	wire					cpu_rst_n,
	
	//来自执行阶段的信息
	input	wire[`YSYX210326_ALUOP_BUS]		exe_aluop,
	...
	//送到访存阶段的信息
	output	reg[`YSYX210326_ALUOP_BUS]			mem_aluop,
    ...
    always@(posedge cpu_clk_50M) begin
		if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
		    mem_aluop   <=      `YSYX210326_RISCV64_SLL;
			mem_wa		<=		`REG_YSYX210326_NOP;
			mem_wreg	<=		`YSYX210326_WRITE_DISABLE;
			mem_wd		<=		`YSYX210326_ZERO_WORD;
			mem_mreg	<=		`YSYX210326_WRITE_DISABLE;
			mem_din		<=		`YSYX210326_ZERO_WORD;
			mem_csr_we	<=		`YSYX210326_FALSE_V;
			mem_csr_waddr	<=	4'b0;
			mem_csr_wdata	<=	`YSYX210326_ZERO_WORD;
		end
		if(excep_flush == `YSYX210326_TRUE_V) begin
		    mem_aluop   <=      `YSYX210326_RISCV64_SLL;
			mem_wa		<=		`REG_YSYX210326_NOP;
			mem_wreg	<=		`YSYX210326_WRITE_DISABLE;
			mem_wd		<=		`YSYX210326_ZERO_WORD;
...
module ysyx_210326_exe_stage(
    
    //从译码阶段获得的信息
	input		wire[`YSYX210326_ALUTYPE_BUS]		exe_alutype_i,
	input		wire[`YSYX210326_ALUOP_BUS]		exe_aluop_i,
	...
	input		wire[`YSYX210326_INST_ADDR_BUS]	exe_pc_i,

	//转移指令添加
	input       wire[`YSYX210326_INST_ADDR_BUS]   ret_addr,
	
	//送至执行阶段的信息
	output		wire[`YSYX210326_ALUOP_BUS]		exe_aluop_o,
	...
	output	wire[`YSYX210326_INST_ADDR_BUS ] excep_flush_pc,
    ...
    wire		[`REG_BUS]				YSYX210326_LOGICres;           //保存逻辑运算的结果
	wire		[`REG_BUS]				YSYX210326_SHIFTres;           //保存移位运算的结果
	wire       	[`REG_BUS]              YSYX210326_MOVEres;           	//保存移动操作的结果
	wire		[`REG_BUS]			    YSYX210326_ARITHres;           //保存算术运算的结果

	//根据内部操作码aluop进行逻辑运算
	assign  YSYX210326_LOGICres = (exe_aluop_i == `YSYX210326_RISCV64_ANDI)   ?   (exe_src1_i & exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_AND)    ?   (exe_src1_i & exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_ORI)    ?   (exe_src1_i | exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_OR)     ?   (exe_src1_i | exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_XORI)   ?   (exe_src1_i ^ exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_XOR)    ?   (exe_src1_i ^ exe_src2_i)  :
	                   (exe_aluop_i == `YSYX210326_RISCV64_LUI)    ?   exe_src2_i 				   :
	                   (exe_aluop_i == `YSYX210326_RISCV64_AUIPC)  ?   (exe_src1_i + exe_src2_i)  :  `YSYX210326_ZERO_WORD;

	wire		[`REG_BUS]			    add_test;
	wire 		[`REG_BUS]				sub_test;
	wire 		[`REG_BUS]				lYSYX210326_SHIFT_test;
	wire 		[`REG_BUS]				rYSYX210326_SHIFT_test;
	assign	add_test = (exe_src1_i + exe_src2_i);
	assign	sub_test = exe_src1_i + (~exe_src2_i) + 1;
	assign	lYSYX210326_SHIFT_test = exe_src1_i << exe_src2_i;
	assign	rYSYX210326_SHIFT_test = {32'b0,exe_src1_i[31:0] >> exe_src2_i};
	//根据内部操作码aluop进行算术运算
	assign	YSYX210326_ARITHres = (exe_aluop_i == `YSYX210326_RISCV64_ADDI)	?	(exe_src1_i + exe_src2_i)  															:
					   (exe_aluop_i == `YSYX210326_RISCV64_ADD)    ?   (exe_src1_i + exe_src2_i)  															:
					   (exe_aluop_i == `YSYX210326_RISCV64_ADDIW)	?	{{32{add_test[31]}},{add_test[31:0]}}												:
					   (exe_aluop_i == `YSYX210326_RISCV64_ADDW)	?	{{32{add_test[31]}},{add_test[31:0]}}												:
					   (exe_aluop_i == `YSYX210326_RISCV64_SUB)    ?   (exe_src1_i + (~exe_src2_i) + 1)   													:
					   (exe_aluop_i == `YSYX210326_RISCV64_SUBW)	?	{{32{sub_test[31]}},{sub_test[31:0]}}												:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLTI)   ?   (($signed(exe_src1_i) < $signed(exe_src2_i))   ?   64'h00000000_00000001 : 64'b0)  	:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLT)    ?   (($signed(exe_src1_i) < $signed(exe_src2_i))   ?   64'h00000000_00000001 : 64'b0)  	:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLTU)   ?   ((exe_src1_i < exe_src2_i)   ?   64'h00000000_00000001 : 64'b0)    					:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLTIU)  ?   ((exe_src1_i < exe_src2_i)   ?   64'h00000000_00000001 : 64'b0)    					:    `YSYX210326_ZERO_WORD;			   
	//根据内部操作码aluop进行移位运算
	assign  YSYX210326_SHIFTres = (exe_aluop_i == `YSYX210326_RISCV64_SLLI)   ?   (exe_src1_i << exe_src2_i)    																			:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLLIW)	?	{{32{lYSYX210326_SHIFT_test[31]}},{lYSYX210326_SHIFT_test[31:0]}}																:
	                   (exe_aluop_i == `YSYX210326_RISCV64_SRLI)   ?   (exe_src1_i >> exe_src2_i)    																			:
					   (exe_aluop_i == `YSYX210326_RISCV64_SRLIW)	?	{{32{rYSYX210326_SHIFT_test[31]}},{rYSYX210326_SHIFT_test[31:0]}}																:
	                   (exe_aluop_i == `YSYX210326_RISCV64_SRAI)   ?   (({64{exe_src1_i[63]}} << (7'd64 - {1'b0,exe_src2_i[5:0]})) | (exe_src1_i >> exe_src2_i))    			:
					   (exe_aluop_i == `YSYX210326_RISCV64_SRAIW)	?	(({64{exe_src1_i[31]}} << (6'd32 - {1'b0,exe_src2_i[5:0]})) | {32'b0,(exe_src1_i[31:0] >> exe_src2_i)})			:
	                   (exe_aluop_i == `YSYX210326_RISCV64_SLL)    ?   (exe_src1_i << exe_src2_i)    																			:
					   (exe_aluop_i == `YSYX210326_RISCV64_SLLW)	?	(({64{exe_src1_i[31]}} << (6'd32 + {1'b0,exe_src2_i[4:0]}))| {32'b0,(exe_src1_i[31:0] << exe_src2_i[4:0])})		:
	                   (exe_aluop_i == `YSYX210326_RISCV64_SRL)    ?   (exe_src1_i >> exe_src2_i)    																			: 
					   (exe_aluop_i == `YSYX210326_RISCV64_SRLW)	?	{32'b0,exe_src1_i[31:0] >> exe_src2_i[4:0]}																:
	                   (exe_aluop_i == `YSYX210326_RISCV64_SRA)    ?   (({64{exe_src1_i[63]}} << (7'd64 - {1'b0,exe_src2_i[5:0]})) | (exe_src1_i >> exe_src2_i))    			:
					   (exe_aluop_i == `YSYX210326_RISCV64_SRAW)	?	(({64{exe_src1_i[31]}} << (6'd32 - {1'b0,exe_src2_i[4:0]})) | {32'b0,(exe_src1_i[31:0] >> exe_src2_i[4:0])})	:	`YSYX210326_ZERO_WORD;
											

	//根据内部类型码alutype确定数据存储器存取操作的地址
	assign     YSYX210326_MOVEres = (exe_alutype_i == `YSYX210326_MOVE) ? (exe_src1_i + exe_src2_i) : `YSYX210326_ZERO_WORD;
	   
							

	//根据内部操作码aluop进行csr指令操作
	assign	exe_csr_we	=	(exe_aluop_i == `YSYX210326_RISCV64_ECALL || (global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && clock_interr == `YSYX210326_TRUE_V))	?	`YSYX210326_TRUE_V	:
							(exe_alutype_i == `CSR)			?	`YSYX210326_TRUE_V		:	`YSYX210326_FALSE_V;
	assign	exe_csr_waddr=	(exe_aluop_i == `YSYX210326_RISCV64_ECALL || (global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && clock_interr == `YSYX210326_TRUE_V))	?	`MEPC			:
							(exe_alutype_i == `CSR)			?	exe_csr_waddr_i	:	4'b0;
	assign	exe_csr_wdata=	(exe_aluop_i == `YSYX210326_RISCV64_ECALL || (global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && clock_interr == `YSYX210326_TRUE_V))	?	exe_pc_i		:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRW)	?	exe_src1_i	:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRS)	?	(exe_src1_i | exe_src2_i)	:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRC)	?	((~exe_src1_i) & exe_src2_i)	:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRWI)?	exe_src1_i	:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRSI)?	(exe_src1_i | exe_src2_i)	:
							(exe_aluop_i == `YSYX210326_RISCV64_CSRRCI)?	((~exe_src1_i) & exe_src2_i)	:	`YSYX210326_ZERO_WORD;

    wire    exe_warning_deltest = (add_test == `YSYX210326_ZERO_WORD && sub_test == `YSYX210326_ZERO_WORD && lYSYX210326_SHIFT_test == `YSYX210326_ZERO_WORD && rYSYX210326_SHIFT_test == `YSYX210326_ZERO_WORD)  ?   `YSYX210326_FALSE_V    :   `YSYX210326_FALSE_V;

    assign  exe_wd_o    =   (exe_alutype_i == `YSYX210326_ARITH)   	?   YSYX210326_ARITHres    :  
					  		(exe_alutype_i ==  `YSYX210326_LOGIC)      ?   YSYX210326_LOGICres    :
					  		(exe_alutype_i ==  `YSYX210326_SHIFT)      ?   YSYX210326_SHIFTres    :
					  		(exe_alutype_i ==  `YSYX210326_MOVE )      ?   YSYX210326_MOVEres     :
							(exe_alutype_i ==  `JUMP)       ?   ret_addr    :
							(exe_alutype_i ==  `CSR)		?	exe_src2_i	:
                            (exe_warning_deltest == `YSYX210326_TRUE_V)?   `YSYX210326_ZERO_WORD  :	`YSYX210326_ZERO_WORD;
	...
	assign	excep_flush	=	((exe_aluop_i == `YSYX210326_RISCV64_ECALL) || exe_aluop_i == `YSYX210326_RISCV64_MRET || (global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && clock_interr == `YSYX210326_TRUE_V && exe_pc_i != `YSYX210326_PC_INIT))	?	`YSYX210326_TRUE_V		:	`YSYX210326_FALSE_V;
	assign 	excep_flush_pc =(global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && clock_interr == `YSYX210326_TRUE_V && exe_pc_i != `YSYX210326_PC_INIT)	?	mtvec_read	:				//(mtvec_read[ 1: 0] == 2'b0)		?	{2'b0,mtvec_read[63:2]}	:
							(exe_aluop_i == `YSYX210326_RISCV64_ECALL)	?	mtvec_read				:															//{2'b0,mtvec_read[63:2]}	:
							(exe_aluop_i == `YSYX210326_RISCV64_MRET)	?	mepc_read				:	`YSYX210326_ZERO_WORD;
	assign	excep_code	= 	(clock_interr== `YSYX210326_TRUE_V && global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && exe_pc_i != `YSYX210326_PC_INIT)	?	`TIME_TRAP_CODE	:
							(exe_aluop_i == `YSYX210326_RISCV64_ECALL)	?	`ECALL_CODE	:	
							(exe_aluop_i == `YSYX210326_RISCV64_MRET)	?	`MRET_CODE	:	3'b0;

	assign	interr_isdone = clock_interr == `YSYX210326_TRUE_V && global_trap_ena == `TRAP_ON && time_trap_ena == `TRAP_ON && exe_pc_i != `YSYX210326_PC_INIT;
...
module ysyx_210326_idexe_reg(
    input   wire    cpu_clk_50M,
    input   wire    cpu_rst_n,
    
    //来自译码阶段的信息
    input   wire [`YSYX210326_ALUTYPE_BUS] id_alutype,
    input   wire [`YSYX210326_ALUOP_BUS]   id_aluop,
	...
	input	wire[`YSYX210326_INST_ADDR_BUS]id_pc,
    
    //送至执行阶段的信息
    output  reg [`YSYX210326_ALUTYPE_BUS]  exe_alutype,
    output  reg [`YSYX210326_ALUOP_BUS]    exe_aluop,
	...
	output	reg [`YSYX210326_INST_ADDR_BUS]exe_pc,
    ...
    always@(posedge cpu_clk_50M) begin
        //复位的时候将送至执行阶段的信息清0
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            exe_alutype <=      `YSYX210326_NOP;
            exe_aluop   <=      `YSYX210326_RISCV64_SLL;
            exe_src1    <=      `YSYX210326_ZERO_WORD;
            exe_src2    <=      `YSYX210326_ZERO_WORD;
            exe_wa      <=      `REG_YSYX210326_NOP;
            exe_wreg    <=      `YSYX210326_WRITE_DISABLE;
            exe_mreg    <=      `YSYX210326_WRITE_DISABLE;
            exe_din     <=      `YSYX210326_ZERO_WORD;
            exe_ret_addr<=      `YSYX210326_ZERO_WORD;
			exe_pc		<=		`YSYX210326_PC_INIT; 
            exe_csr_waddr<=     4'b0;
        end
        else  if(excep_flush == `YSYX210326_TRUE_V)    begin
            exe_alutype <=      `YSYX210326_NOP;
            exe_aluop   <=      `YSYX210326_RISCV64_SLL;
            exe_src1    <=      `YSYX210326_ZERO_WORD;
            exe_src2    <=      `YSYX210326_ZERO_WORD;
...
module ysyx_210326_id_stage(
    
    input  wire                     cpu_rst_n,
    // 从取值阶段获得的pc值与指令
    input  wire [`YSYX210326_INST_ADDR_BUS]    id_pc_i,
    input  wire [`YSYX210326_INST_ADDR_BUS]    pc_plus_4,
    input  wire [`YSYX210326_INST_BUS     ]    id_inst_i,
    ...
    // 送至执行阶段的译码信息
    output wire [`YSYX210326_ALUTYPE_BUS  ]    id_alutype_o,
    output wire [`YSYX210326_ALUOP_BUS    ]    id_aluop_o,
    output wire [`REG_ADDR_BUS ]    id_wa_o,
    output wire                     id_wreg_o,
    output wire                     id_mreg_o,
    output wire [`REG_BUS      ]    id_din_o,
	output wire [`YSYX210326_INST_ADDR_BUS]	id_pc_o,
    ...
    input   wire [`YSYX210326_INST_ADDR_BUS]   id_jump_pc_i,       //预测跳转目标pc值
    
    // 送回译码阶段的跳转地址
    output  wire                     flush,             //分支预测错误时回传流水线冲刷信号
    output  wire [`YSYX210326_INST_ADDR_BUS]    flush_addr,        //分支预测错误时回传流水线冲刷地址
    output  wire [`YSYX210326_INST_ADDR_BUS]    ret_addr,          //函数调用的返回地址
    ...
    output  wire [`YSYX210326_INST_ADDR_BUS]   btb_update_prepc,    //btb表当前写入指令跳转pc
    ...
    // 根据小端模式组织指令字
    wire [`YSYX210326_INST_BUS] id_inst;
    assign id_inst = (cpu_rst_n == `YSYX210326_RST_ENABLE)	?	32'b0 : id_inst_i;                          //(cpu_rst_n == `YSYX210326_RST_ENABLE)   ?   `YSYX210326_ZERO_INST  :   {id_inst_i[7:0],id_inst_i[15:8],id_inst_i[23:16],id_inst_i[31:24]};
    ...
    //  移位使能信号
    wire YSYX210326_SHIFT      =   inst_slli | inst_srli | inst_srai | inst_sll | inst_srl | inst_sra | inst_slliw | inst_srliw | inst_sraiw;
    wire YSYX210326_SHIFT_r    =   inst_sll | inst_srl | inst_sra | inst_sllw | inst_srlw | inst_sraw;

    //移位位数
    wire [`YSYX210326_INST_ADDR_BUS] YSYX210326_SHIFT_ra    = (YSYX210326_SHIFT_r == `YSYX210326_YSYX210326_SHIFT_ENABLE)  ?     {58'b0, rd2[5:0]}             :
                                        (YSYX210326_SHIFT   == `YSYX210326_YSYX210326_SHIFT_ENABLE)  ?     {58'b0,id_inst[25], rs2[4:0]} : `YSYX210326_ZERO_WORD; 
    ...
    wire    [`REG_BUS]  imm_ext =   (i_imm) ? {{53{id_inst[31]}},id_inst[30:20]} :
                                    ...
                                    (j_imm) ? {{44{id_inst[31]}},id_inst[19:12],id_inst[20],id_inst[30:21],1'b0} : `YSYX210326_ZERO_WORD;
    ...
    assign  csr_raddr   =   (mret)  ?   `MEPC   :
                            (ecall) ?   `MTVEC  :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h300)  ?   `MSTATUS   :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h305)  ?   `MTVEC     :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h341)  ?   `MEPC      :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h342)  ?   `MCAUSE    :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h304)  ?   `MIE       :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h344)  ?   `MIP       :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'hB00)  ?   `MCYCLE    :
                            (inst_csr == `YSYX210326_TRUE_V && csr == 12'h340)  ?   `MSCRATCH  :       4'b0;
    wire[`YSYX210326_WORD_BUS] csr_imm =   (csr_i) ?   {59'b0,rs1} :   `YSYX210326_ZERO_WORD;
    assign  id_csr_waddr    =   (inst_csr && ~mret && ~ecall)  ?   csr_raddr   :  4'b0; 
        
    //csr定向回传添加
    wire[`YSYX210326_WORD_BUS] csr_rdata_select = (exe2id_csr_we == `YSYX210326_WRITE_ENABLE && exe2id_csr_waddr == csr_raddr && csr_raddr != 4'b0)   ?   exe2id_csr_wdata    :
                                       (mem2id_csr_we == `YSYX210326_WRITE_ENABLE && mem2id_csr_waddr == csr_raddr && csr_raddr != 4'b0)   ?   mem2id_csr_wdata    :   csr_rdata;
    ...
    wire [1:0]  fwrd1   =   (exe2id_wreg == `YSYX210326_WRITE_ENABLE && exe2id_wa == ra1 && ra1 != 5'b0)  ?   2'b01   :
                            (mem2id_wreg == `YSYX210326_WRITE_ENABLE && mem2id_wa == ra1 && ra1 != 5'b0)  ?   2'b10   :   2'b11;

    //源操作数2选择信号（可能来自立即数或寄存器读端口2或定向回传）
    wire [1:0]  fwrd2   =   (exe2id_wreg == `YSYX210326_WRITE_ENABLE && exe2id_wa == ra2 && ra2 != 5'b0)  ?   2'b01   :
                            (mem2id_wreg == `YSYX210326_WRITE_ENABLE && mem2id_wa == ra2 && ra2 != 5'b0)  ?   2'b10   :   2'b11;                      
    ...
    assign  id_src2_o   =   (csr_i | csr_r)             ?   csr_rdata_select   :
                            (immsel == `YSYX210326_IMM_ENABLE )    ?   imm_ext     : 
                            (YSYX210326_SHIFT == `YSYX210326_YSYX210326_SHIFT_ENABLE)    ?   YSYX210326_SHIFT_ra    :
    ...
    //加载相关暂停信号
    assign  id_stall    =   ((fwrd1 == 2'b01 || fwrd2 == 2'b01) && (exe2id_mreg == `YSYX210326_TRUE_V))    ?   `STOP   :
                            ((fwrd1 == 2'b10 || fwrd2 == 2'b10) && (mem2id_mreg == `YSYX210326_TRUE_V))    ?   `STOP   :   `NOSTOP;
    ...
    //生成转移地址计算所需信号
    wire [`YSYX210326_INST_ADDR_BUS] imm_jump = (inst_jalr) ? {{52{id_inst[31]}},id_inst[31: 20]}  :
                                     (inst_jal ) ? {{44{id_inst[31]}},id_inst[19:12],id_inst[20],id_inst[30:21],1'b0}  :
                                     (b_imm)     ? {{52{id_inst[31]}},id_inst[7],id_inst[30:25],id_inst[11:8],1'b0}  :   `YSYX210326_ZERO_WORD;
    ...
    //获得转移地址
    wire [`YSYX210326_INST_ADDR_BUS] jump_addr;
    assign  jump_addr = (inst_jal | equ)    ?   id_pc_i + imm_jump  :
                        (inst_jalr)         ?   id_src1_o + imm_jump      :   pc_plus_4;
                        
    assign  flush   =   (id_stall == `STOP)    ?   `YSYX210326_JUMP_DISABLE   :
                        (jtsel == `YSYX210326_JUMP_ENABLE  && id_jump_ena_i == `YSYX210326_JUMP_DISABLE)                              ?   1'b1    :
                        (jtsel == `YSYX210326_JUMP_DISABLE && id_jump_ena_i == `YSYX210326_JUMP_ENABLE )                              ?   1'b1    :
                        (jtsel == `YSYX210326_JUMP_ENABLE  && id_jump_ena_i == `YSYX210326_JUMP_ENABLE && jump_addr != id_jump_pc_i)  ?   1'b1    :    1'b0;   
    
    assign  flush_addr = (flush == `YSYX210326_FALSE_V)    ?   `YSYX210326_ZERO_WORD  :
                         (flush == `YSYX210326_TRUE_V && jtsel == `YSYX210326_JUMP_ENABLE)     ?   jump_addr   :
                         (flush == `YSYX210326_TRUE_V && jtsel == `YSYX210326_JUMP_DISABLE)    ?   pc_plus_4   :   `YSYX210326_ZERO_WORD;
    
    assign  btb_update_req  =   (id_stall == `STOP)    ?   `YSYX210326_FALSE_V : (inst_jal | inst_jalr | b_imm);                               
    assign  btb_update_state=   jtsel;
    assign  btb_update_pc   =   (btb_update_req == `YSYX210326_TRUE_V)   ?   id_pc_i[11:2]   :   10'b0;
    assign  btb_update_prepc=   (btb_update_req == `YSYX210326_TRUE_V)   ?   jump_addr 	     :   `YSYX210326_ZERO_WORD; 
...
module ysyx_210326_ifid_reg(
    input   wire    cpu_clk_50M,
    input   wire    cpu_rst_n,
    
    //来自取值阶段的信息
    input   wire [`YSYX210326_INST_ADDR_BUS]   if_pc,
    input   wire [`YSYX210326_INST_BUS     ]   if_inst,
    input   wire [`YSYX210326_INST_ADDR_BUS]   if_pc_plus_4,
    
    //送至译码阶段的信息
    output  reg [`YSYX210326_INST_ADDR_BUS]    id_pc,
    output  reg [`YSYX210326_INST_BUS     ]    id_inst,
    output  reg [`YSYX210326_INST_ADDR_BUS]    id_pc_plus_4,
    ...
    input   wire [`YSYX210326_INST_ADDR_BUS]   if_jump_pc,
    input   wire                    flush,
    
    output  reg                     id_jump_ena,
    output  reg [`YSYX210326_INST_ADDR_BUS]    id_jump_pc,
    ...
    always@(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin //复位或流水线冲刷的时候将译码阶段的信息清0
            id_pc           <=  `YSYX210326_PC_INIT;
            id_inst         <=  `YSYX210326_ZERO_INST;
            id_pc_plus_4    <=  `YSYX210326_PC_INIT;
            id_jump_ena     <=  `YSYX210326_JUMP_DISABLE;
            id_jump_pc      <=  `YSYX210326_PC_INIT;
        end
        else if(handshake_done == `YSYX210326_FALSE_V || flush == `YSYX210326_TRUE_V || excep_flush == `YSYX210326_TRUE_V) begin       //指令未取到时暂停译码
            id_pc           <=  `YSYX210326_PC_INIT;
            id_inst         <=  `YSYX210326_ZERO_INST;
            id_pc_plus_4    <=  `YSYX210326_PC_INIT;
            id_jump_ena     <=  `YSYX210326_JUMP_DISABLE;
...
module ysyx_210326_if_stage(
    input       wire        cpu_clk_50M,
    input       wire        cpu_rst_n,
    
    output 	    wire  [`YSYX210326_INST_ADDR_BUS] 	    if_pc_o,
    output      wire  [`YSYX210326_INST_BUS     ]       if_inst_o,
    ...
    input       wire [`YSYX210326_INST_ADDR_BUS]       if_pre_pc,
    output      wire                        jump_ena_o, //跳转使能，是否预测跳转
    output      wire [`YSYX210326_INST_ADDR_BUS]       jump_pc_o, 	//预测跳转地址
    
    //预测错误回传信号
    input       wire [`YSYX210326_INST_ADDR_BUS]       flush_addr,
    input       wire                        flush,
    output      wire [`YSYX210326_INST_ADDR_BUS]       pc_plus_4,

    //异常处理跳转执行相关信号添加
    input       wire                        excep_flush,
    input       wire [`YSYX210326_INST_ADDR_BUS]       excep_flush_pc
    
    );

    reg [`YSYX210326_INST_ADDR_BUS] pc;

    assign pc_plus_4 = (cpu_rst_n == `YSYX210326_RST_ENABLE) ? `YSYX210326_PC_INIT   :    pc+4;

    reg ce;
    always@(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            ce <= `YSYX210326_CHIP_DISABLE;          //复位的时候指令存储器禁用
        end else begin
            ce <= `YSYX210326_CHIP_ENABLE;            //复位结束时，指令存储器使能
        end
    end
    ...
    always@(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            hs_ena <= `YSYX210326_FALSE_V;
        end
        else if(flush == `YSYX210326_TRUE_V) begin
            hs_ena <= `YSYX210326_FALSE_V;
        end
        else if(if_ready == `YSYX210326_TRUE_V) begin
            hs_ena <= `YSYX210326_TRUE_V;
        end
    end
    ...
    assign  handshake_done = (hs_ena == `YSYX210326_FALSE_V)   ?   `YSYX210326_FALSE_V    :   if_valid & if_ready;

    assign  if_valid    =   (excep_flush == `YSYX210326_TRUE_V)                        ?   ce              :
                            (cpu_rst_n == `YSYX210326_RST_ENABLE || flush == `YSYX210326_TRUE_V)  ?   `YSYX210326_CHIP_DISABLE   :   ce;
    assign  if_size     = `SIZE_W;
    assign  if_addr     = pc[31: 0];
    assign  if_inst_o   = (excep_inst_del == `YSYX210326_FALSE_V && handshake_done == `YSYX210326_TRUE_V) ?  if_data_read          :   `YSYX210326_ZERO_INST;
    assign  if_pc_o     = (excep_inst_del == `YSYX210326_FALSE_V && handshake_done == `YSYX210326_TRUE_V) ?  pc                    :   `YSYX210326_PC_INIT;
    /************************axi访问信号添加************************/

    /************************分支预测添加************************/
    wire is_jal  = (if_inst_o[6:0] == 7'b1101111)    ?   `YSYX210326_TRUE_V    :    `YSYX210326_FALSE_V;
    wire is_jalr = (if_inst_o[6:0] == 7'b1100111)    ?   `YSYX210326_TRUE_V    :    `YSYX210326_FALSE_V;
    wire is_bj   = (if_inst_o[6:0] == 7'b1100011)    ?   `YSYX210326_TRUE_V    :    `YSYX210326_FALSE_V;
    wire is_jump = is_jal | is_jalr | is_bj;   
     
    wire [`YSYX210326_INST_ADDR_BUS] pc_next;

    assign  jump_ena_o  = (is_jump    == `YSYX210326_TRUE_V && if_pre_jumpena == `YSYX210326_JUMP_ENABLE)	  ?   	`YSYX210326_JUMP_ENABLE	:	`YSYX210326_JUMP_DISABLE;
    assign  jump_pc_o   = (jump_ena_o == `YSYX210326_JUMP_ENABLE)	            ?   if_pre_pc       : 	`YSYX210326_ZERO_WORD;
    assign  pc_next     = (excep_flush== `YSYX210326_TRUE_V)                   ?   excep_flush_pc  :
                          (flush 	  == `YSYX210326_TRUE_V)     		        ?   flush_addr  	:   
                          (jump_ena_o == `YSYX210326_JUMP_ENABLE)          	?   jump_pc_o  		:   pc_plus_4;
    /***********************分支预测添加*************************/
    ...
    always @(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            excep_inst_del  <= `YSYX210326_FALSE_V;
            excep_inst_del_delay <= 2'b0;
        end
        else if(excep_flush == `YSYX210326_TRUE_V) begin
            excep_inst_del  <= `YSYX210326_TRUE_V;
            excep_inst_del_delay <= 2'b01;
        end
        else if(handshake_done == `YSYX210326_TRUE_V && excep_inst_del == `YSYX210326_TRUE_V) begin
    ...
    assign  pc_stall=  (excep_flush == `YSYX210326_TRUE_V)    ?   `YSYX210326_FALSE_V    :
                        (flush == `YSYX210326_TRUE_V)          ?   `YSYX210326_FALSE_V    :
                        (stall == `NOSTOP && handshake_done == `YSYX210326_TRUE_V && excep_inst_del == `YSYX210326_FALSE_V) ?   `YSYX210326_FALSE_V    :
                        (if_resp == 2'b0)   ?   `YSYX210326_TRUE_V  :   `YSYX210326_TRUE_V;


    always@(posedge cpu_clk_50M) begin
        if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
            pc <= `YSYX210326_PC_INIT;
        end
        if(ce == `YSYX210326_CHIP_DISABLE)
            //指令存储器禁用的时候，PC保持初始值
            pc <= `YSYX210326_PC_INIT;
        else if(pc_stall == `YSYX210326_FALSE_V) begin
            pc <= pc_next;
        end
    end
...
module ysyx_210326_mem_stage(

	
	//	从执行阶段获得的信息
	input	wire[`YSYX210326_ALUOP_BUS]	mem_aluop_i,
	input	wire[`REG_ADDR_BUS]	mem_wa_i,
	input	wire				mem_wreg_i,
	input	wire[`YSYX210326_WORD_BUS]		mem_wd_i,
	input	wire 				mem_mreg_i,
	input	wire[`YSYX210326_WORD_BUS]		mem_din_i,
	...
	output	wire[`YSYX210326_BSEL_BUS]		dre,
	output	wire[`YSYX210326_WORD_BUS]		mem_dm_o,

	//	送至数据存储器的读信号
	output	wire 				rvalid,
	input						r_ready,
	input	wire[`YSYX210326_WORD_BUS]		data_read,
	output	wire[`YSYX210326_WORD_BUS]		raddr,
	output	wire[ 1: 0]			rsize,
	input	wire[ 1: 0]			resp,
	
	//	送至数据存储器的写信号
	output	wire[`YSYX210326_WORD_BUS]		waddr,
	output	wire[`YSYX210326_WORD_BUS]		wdata,
	...
	assign 	rvalid	=	(d_rce)	?	`YSYX210326_TRUE_V	:	`YSYX210326_FALSE_V;
	...
	//	获得数据存储器的访问数据
	assign mem_dm_o =	(read_handshake_done == `YSYX210326_TRUE_V)	? data_read	:	`YSYX210326_ZERO_WORD;

	//	读数据存储器产生的流水线暂停信号
	assign	d_stall	=	((d_wce == `YSYX210326_TRUE_V && write_is_down == `YSYX210326_FALSE_V && waddr[27:16] != `CLINT_ADDR) || (d_rce == `YSYX210326_TRUE_V && read_handshake_done == `YSYX210326_FALSE_V))	?	`STOP	:	`NOSTOP;
    ...
    // 确定待写入数据存储器的数据
    assign  wdata   = (d_wce == `YSYX210326_FALSE_V)			?	`YSYX210326_ZERO_WORD	:
					  ...
					  (wmask == 8'b0000_0011       ) ? {{48{1'b0}}, mem_din_i[15:0]}    : `YSYX210326_ZERO_WORD;

endmodule

module	ysyx_210326_memwb_reg(
	input		wire				cpu_clk_50M,
	input		wire				cpu_rst_n,
	...
	input		wire 				mem_mreg,
	input		wire[`YSYX210326_BSEL_BUS]		mem_dre,
	input		wire 				mem_sign,
	input		wire[`YSYX210326_WORD_BUS]		mem_dm,
	...
	output		reg 				wb_mreg,
	output		reg[`YSYX210326_BSEL_BUS]		wb_dre,
	output		reg 				wb_sign,
	output		reg[`YSYX210326_WORD_BUS]		wb_dm,
	...
	always@(posedge cpu_clk_50M) begin
		//复位的时候将送至写回阶段的信息清0
		if(cpu_rst_n == `YSYX210326_RST_ENABLE) begin
			wb_wa		<=			`REG_YSYX210326_NOP;
			wb_wreg		<=			`YSYX210326_WRITE_DISABLE;
			wb_dreg		<=			`YSYX210326_ZERO_WORD;
			wb_mreg		<=			`YSYX210326_WRITE_DISABLE;
			wb_dre		<=			4'b0;
			wb_sign		<=			`YSYX210326_FALSE_V;
			wb_dm		<=			`YSYX210326_ZERO_WORD;
			wb_csr_we	<=			`YSYX210326_FALSE_V;
			wb_csr_waddr<=			4'b0;
			wb_csr_wdata<=			`YSYX210326_ZERO_WORD;
		end
		//将来自访存阶段的信息寄存并送至写回阶段
		else if(data_read_stall == `NOSTOP) begin
			wb_wa		<=			mem_wa;
...
module ysyx_210326_regfile(
	...
	always @(posedge cpu_clk_50M) begin
		if (cpu_rst_n == `YSYX210326_RST_ENABLE) begin
			regs[ 0] <= `YSYX210326_ZERO_WORD;
			regs[ 1] <= `YSYX210326_ZERO_WORD;
			regs[ 2] <= `YSYX210326_ZERO_WORD;
			regs[ 3] <= `YSYX210326_ZERO_WORD;
			regs[ 4] <= `YSYX210326_ZERO_WORD;
			regs[ 5] <= `YSYX210326_ZERO_WORD;
			regs[ 6] <= `YSYX210326_ZERO_WORD;
			regs[ 7] <= `YSYX210326_ZERO_WORD;
			regs[ 8] <= `YSYX210326_ZERO_WORD;
			regs[ 9] <= `YSYX210326_ZERO_WORD;
			regs[10] <= `YSYX210326_ZERO_WORD;
			regs[11] <= `YSYX210326_ZERO_WORD;
			regs[12] <= `YSYX210326_ZERO_WORD;
			regs[13] <= `YSYX210326_ZERO_WORD;
			regs[14] <= `YSYX210326_ZERO_WORD;
			regs[15] <= `YSYX210326_ZERO_WORD;
			regs[16] <= `YSYX210326_ZERO_WORD;
			regs[17] <= `YSYX210326_ZERO_WORD;
			regs[18] <= `YSYX210326_ZERO_WORD;
			regs[19] <= `YSYX210326_ZERO_WORD;
			regs[20] <= `YSYX210326_ZERO_WORD;
			regs[21] <= `YSYX210326_ZERO_WORD;
			regs[22] <= `YSYX210326_ZERO_WORD;
			regs[23] <= `YSYX210326_ZERO_WORD;
			regs[24] <= `YSYX210326_ZERO_WORD;
			regs[25] <= `YSYX210326_ZERO_WORD;
			regs[26] <= `YSYX210326_ZERO_WORD;
			regs[27] <= `YSYX210326_ZERO_WORD;
			regs[28] <= `YSYX210326_ZERO_WORD;
			regs[29] <= `YSYX210326_ZERO_WORD;
			regs[30] <= `YSYX210326_ZERO_WORD;
			regs[31] <= `YSYX210326_ZERO_WORD;
		end
		else begin
			if ((we == `YSYX210326_WRITE_ENABLE) && (wa != 5'h0))	
				regs[wa] <= wd;
		end
	end
	...
	// ra1是读地址、wa是写地址、we是写使能、wd是要写入的数据 
	always @(*) begin
		if (cpu_rst_n == `YSYX210326_RST_ENABLE)
			rd1 = `YSYX210326_ZERO_WORD;
		else if (ra1 == `REG_YSYX210326_NOP)
			rd1 = `YSYX210326_ZERO_WORD;
		else if ((we == `YSYX210326_WRITE_ENABLE) && (wa == ra1))
		    rd1 = wd;
		else 
			rd1 = regs[ra1];
	end
	...
	always @(*) begin
		if (cpu_rst_n == `YSYX210326_RST_ENABLE)
			rd2 = `YSYX210326_ZERO_WORD;
		else if (ra2 == `REG_YSYX210326_NOP)
			rd2 = `YSYX210326_ZERO_WORD;
		else if ((we == `YSYX210326_WRITE_ENABLE) && (wa == ra2))
		    rd2 = wd;
		else 
			rd2 = regs[ra2];
	end
 ...
 module ysyx_210326_rvcpu(
    ...
    output      wire[`YSYX210326_WORD_BUS]         d_waddr,
    output      wire[`YSYX210326_WORD_BUS]         d_wdata,
    input       wire                    write_is_down,
    ...
    //连接取值阶段到取值译码寄存器阶段的信号
    wire[`YSYX210326_INST_ADDR_BUS]        pc;
    wire[`YSYX210326_INST_BUS]             if_inst_o;

    wire                        handshake_done; //取值完成信号

    //连接取值译码寄存器到译码阶段的信号
    wire[`YSYX210326_INST_ADDR_BUS]        id_pc_i;
    wire[`YSYX210326_INST_BUS]             id_inst_i;
    ...
    //转移指令添加
    wire [`YSYX210326_INST_ADDR_BUS ] 	if_pc_plus_4;
    wire [`YSYX210326_INST_ADDR_BUS ] 	id_pc_plus_4;
    wire [`REG_BUS       ] 	id_ret_addr;
    wire [`REG_BUS       ] 	exe_ret_addr;

    //连接译码阶段到译码执行寄存器的信号
    wire[`YSYX210326_ALUTYPE_BUS]          id_alutype_o;
    wire[`YSYX210326_ALUOP_BUS]            id_aluop_o;
    ...
    wire[`YSYX210326_INST_ADDR_BUS]        id_pc_o;

    //连接译码执行寄存器到执行阶段的信号
    wire[`YSYX210326_ALUTYPE_BUS]          exe_alutype_i;
    wire[`YSYX210326_ALUOP_BUS]            exe_aluop_i;
    ...
    wire[`YSYX210326_INST_ADDR_BUS]        exe_pc_i;

    //连接执行阶段到执行访存寄存器的信号
    wire[`YSYX210326_ALUOP_BUS]            exe_aluop_o; 
    ...
    //连接执行访存寄存器到访存阶段的信号
    wire[`YSYX210326_ALUOP_BUS]            mem_aluop_i;
    ...
    wire                        mem_mreg_o;
    wire[`YSYX210326_BSEL_BUS]             mem_dre_o;
    wire                        mem_sign_o;
    wire[`YSYX210326_WORD_BUS]             mem_dm_o;
    ...
    wire                        wb_mreg_i;
    wire[`YSYX210326_BSEL_BUS]             wb_dre_i;
    wire                        wb_sign_i;
    wire[`YSYX210326_WORD_BUS]             wb_dm_i;
	...
	//btb到取值阶段的信号
	wire                   btb_jump_ena;
	wire[`YSYX210326_INST_ADDR_BUS]   btb_prepc_o;
	
	//取值到取值/译码寄存器的信号
	wire                   if_jump_ena;
	wire[`YSYX210326_INST_ADDR_BUS]   if_jump_pc;
	
	//取值/译码寄存器到译码阶段的信号
	wire                   id_jump_ena;
	wire[`YSYX210326_INST_ADDR_BUS]   id_jump_pc;
	
	//译码阶段到btb的更新信号
	wire                   btb_update_req;
	wire                   btb_update_state;
	wire[`PC_ADDR_BTB  ]   btb_update_pc;
	wire[`YSYX210326_INST_ADDR_BUS]   btb_update_prepc;
	
	//译码阶段传出的流水线冲刷信号
	wire                   flush;
	wire[`YSYX210326_INST_ADDR_BUS]   flush_addr;
    ...
    wire                    excep_flush;
    wire[`YSYX210326_INST_ADDR_BUS]    excep_flush_pc;
    ...
    ysyx_210326_if_stage    if_stage0(
    ...
    ysyx_210326_ifid_reg    ifid_reg0(
        .cpu_clk_50M(cpu_clk_50M),.cpu_rst_n(cpu_rst_n),
    ...
    ysyx_210326_id_stage    id_stage0(
        .cpu_rst_n(cpu_rst_n),
    ...
    ysyx_210326_idexe_reg   idexe_reg0(
        .cpu_clk_50M(cpu_clk_50M),.cpu_rst_n(cpu_rst_n),
    ...
    ysyx_210326_exe_stage   exe_stage0(
    ...
    ysyx_210326_exemem_reg  exemem_reg0(
        .cpu_clk_50M(cpu_clk_50M),.cpu_rst_n(cpu_rst_n),
    ...
    ysyx_210326_mem_stage   mem_stage0(
    ...
    ysyx_210326_memwb_reg   memwb_reg0(
        .cpu_clk_50M(cpu_clk_50M),.cpu_rst_n(cpu_rst_n),
    ...
    ysyx_210326_wb_stage    wb_stage0(
...
module ysyx_210326(
    ...
    wire d_rvalid;
    wire d_rready;
    wire [`YSYX210326_WORD_BUS]  d_data_read;
    wire [`YSYX210326_WORD_BUS]  d_raddr;
    wire [ 1: 0]      d_rsize;
    wire [ 1: 0]      d_resp;

    //mem-write
    wire [`YSYX210326_WORD_BUS]        d_waddr;
    wire [`YSYX210326_WORD_BUS]        data_write;
    wire [ 7: 0]            d_wmask;
    wire                    d_wce;
    wire                    write_is_down;
    ...
    wire r_ready_i;
    wire r_req = `REQ_READ;
    wire [`YSYX210326_WORD_BUS]      data_read_i;
    wire [`AXI_ADDR_WIDTH-1 : 0]      r_addr_o;
    wire [ 1: 0]          r_size_o;
    wire [ 1: 0]          r_resp_i;

    reg [`YSYX210326_WORD_BUS]        axi_d_waddr;
    reg [`YSYX210326_WORD_BUS]        axi_data_write;
    reg [ 7: 0]            axi_d_wmask;
    reg                    axi_d_wce;
    ...
    assign io_slave_rdata   = `YSYX210326_ZERO_WORD;
    assign io_slave_rlast   = 0;
    assign io_slave_rid     = 4'b0;

    ysyx_210326_axi_rw axi_rw0 (
        .clock                          (clock),
        .reset                          (reset),
    ...
    always@(negedge clock) begin
      if(reset == `YSYX210326_RST_ENABLE) begin
        read_state  <=  `INST_READ;
        count       <=  0;
      end 
      else if(r_ready_i == `YSYX210326_TRUE_V && (d_rvalid == `YSYX210326_TRUE_V && d_waddr[27:16] != `CLINT_ADDR)) begin
        read_state  <=  `DATA_READ;
        count       <=  count + 1;
      end
      else if(d_rvalid == `YSYX210326_FALSE_V) begin
        read_state  <=  `INST_READ;
        count       <=  0;
      end
    end

    wire[`YSYX210326_WORD_BUS] clint_data_read;
    ...
    assign d_rready   = (clint_data_read != `YSYX210326_ZERO_WORD) ? `YSYX210326_TRUE_V : 
                        (read_state == `DATA_READ && count != 1)  ? r_ready_i  : `YSYX210326_FALSE_V;
    assign d_data_read= (clint_data_read != `YSYX210326_ZERO_WORD) ? clint_data_read : 
                        (read_state == `DATA_READ)  ? data_read_i : `YSYX210326_ZERO_WORD;
    assign if_resp    = r_resp_i;
    assign if_ready   = (read_state == `INST_READ)  ? r_ready_i  : `YSYX210326_FALSE_V;
    ...
    wire clint_we = (d_wce == `YSYX210326_TRUE_V && (d_waddr[27:16] != `CLINT_ADDR)) ? `YSYX210326_TRUE_V : `YSYX210326_FALSE_V;
    ysyx_210326_clint clint0(
        .cpu_clk_50M(clock),.cpu_rst_n(reset),
...
module ysyx_210326_wb_stage(
	...
	input	wire[`YSYX210326_BSEL_BUS]		wb_dre_i,
	input	wire 				sign,
	...
	output	wire[`YSYX210326_WORD_BUS]		wb_wd_o,

	//来自数据存储器的数据
	input	wire[`YSYX210326_WORD_BUS]		dm,
    ...
    assign  csr_wdata   =   (wb_csr_we_i == `YSYX210326_TRUE_V && wb_csr_waddr_i == `MSTATUS && (wb_csr_wdata_i[16:15] == 2'b11 || wb_csr_wdata_i[14:13] == 2'b11))    ?   {1'b1,wb_csr_wdata_i[62:0]} :
                            (wb_csr_we_i == `YSYX210326_TRUE_V && wb_csr_waddr_i == `MSTATUS)  ?   {1'b0,wb_csr_wdata_i[62:0]} : wb_csr_wdata_i;

	//传至通用寄存器堆的信息
	assign	wb_wa_o		=	wb_wa_i;
	assign	wb_wreg_o	=	wb_wreg_i;

    wire    [`YSYX210326_WORD_BUS] data    =   (wb_dre_i[3] == `YSYX210326_TRUE_V)    ?   dm  :
                                    (wb_dre_i[2] == `YSYX210326_TRUE_V && sign)    ?   {{32{dm[31]}},dm[31: 0]}    :
                                    (wb_dre_i[2] == `YSYX210326_TRUE_V && ~sign)   ?   {{32{1'b0}},dm[31: 0]}      :
                                    (wb_dre_i[1] == `YSYX210326_TRUE_V && sign)    ?   {{48{dm[15]}},dm[15: 0]}    :
                                    (wb_dre_i[1] == `YSYX210326_TRUE_V && ~sign)   ?   {{48{1'b0}},dm[15: 0]}      :
                                    (wb_dre_i[0] == `YSYX210326_TRUE_V && sign)    ?   {{56{dm[7]}},dm[ 7: 0]}    :
                                    (wb_dre_i[0] == `YSYX210326_TRUE_V && ~sign)   ?   {{56{1'b0}},dm[ 7: 0]}      :   `YSYX210326_ZERO_WORD;

    assign wb_wd_o = (wb_mreg_i == `YSYX210326_MREG_ENABLE) ?  data  :   wb_dreg_i;		
